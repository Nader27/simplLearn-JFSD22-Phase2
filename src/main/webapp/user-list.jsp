...
<jsp:useBean id="listUser" scope="request" type="java.util.List<com.vodafone.learner_academy.model.User>"/>
        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="user" items="${listUser}">
                ...
                <tr>
                    ...
                    <td>
                        <c:out value="${user.userType.type}"/>
                    </td>
                    <td><a href="editUser?id=<c:out value='${user.id}' />">Edit</a> &nbsp;&nbsp;&nbsp; <a
                            href="deleteUser?id=<c:out value='${user.id}' />">Delete</a> &nbsp;&nbsp;&nbsp; <a
                            href="editUserPassword?id=<c:out value='${user.id}' />">Change Password</a></td>
                </tr>
            </c:forEach>
            <!-- } -->
            </tbody>

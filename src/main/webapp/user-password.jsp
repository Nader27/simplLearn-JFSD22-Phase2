...
<jsp:useBean id="user" scope="request" type="com.vodafone.learner_academy.model.User"/>
...
<header>
    <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li><a href="<%=request.getContextPath()%>/editUserPassword?id=<%=user.getId()%>" class="nav-link">Edit
                Password</a></li>
        </ul>
